...
// $0.08 per inspection). Scored once on a held-out test set:
//
//   81% of damaged photos found, 72% of damage groups, 0% false alarms on
//   clean customer photos, about $0.019 per inspection (six photos, live).
//
// Beat, on the tuning set: the plain prompt (80%), the full damage guide (74%;
// it made the model cautious), labelled example photos (74%), and the tuned
// prompt with thinking on (77%, at higher cost). Agreement across photos is
// what brings false alarms to zero.
